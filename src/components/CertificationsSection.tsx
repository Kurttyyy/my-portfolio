        ...
        <Col xs={24} sm={20} md={14} lg={10} xl={8}>
          <Card className="project-card">
            ...
            <Paragraph>
              ...
              <strong>Networking Basics</strong> course from Cisco
              Networking Academy, demonstrating knowledge of networking
              concepts, IPv4/IPv6 addressing, Ethernet communications,
              routing, wireless networking, and troubleshooting.
            </Paragraph>
